...
- **Conformance evidence for `v0.7`: the Python, Go and C++ reference ports.** The normative text is complete, and three implementations of §3.5/§4.4/§4.6/§4.9 reproduce the release's fingerprints on the release fixture, byte for byte:
