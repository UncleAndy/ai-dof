...
DOF-Core estas decido-verifikada protokolo kiu apartigas generan kreivecon (*Generator*) de determinisma matematika validigo (*Calculus Core*). Ĝia celo estas maksimumigi la totalan grafon de libereco (DoF) de la sistemo, structure malpermesante la detruon de DoF de iu ajn ento por loka gajno.
